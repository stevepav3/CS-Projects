...
public class BST<E> implements Tree<E> {
    ...
    // Counts number of leaves in BST recursively
    protected int getNumberOfLeaves(TreeNode<E> root) {
        ...
        if (root.left == null && root.right == null) {
            // Return/add 1 to return count if node meets conditions of leaf node
            return 1;
        }
        
        // Recursively go through tree down each branch        
    ...
    // Similar to getNumberOfLeaves, except method adds 1 when 
    // node does not pass the qualifications for a leaf node
    protected int getNumberOfNonLeaves(TreeNode<E> root) {
        ...
        if (root.left == null && root.right == null) {  // Leaf node doesn't count
            return 0;
        }
